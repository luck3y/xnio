...
public final class JsseSslStreamConnection extends SslConnection {
    ...
    public JsseSslStreamConnection(final StreamConnection streamConnection, final SSLEngine engine, final boolean startls) {
        this(streamConnection, engine, JsseXnioSsl.bufferPool, JsseXnioSsl.bufferPool, startls);
    }
